...
file_path = "./output/ExtractedCourseDescriptions.csv"
...
st.markdown("<h3>Discover the perfect courses to match your skills and interests!</h3>",
            unsafe_allow_html=True)
...
def handle_message():
    ...
    if user_message:
        ...
        st.session_state.messages.append(
            "ChatGPT: I'm here to help you with course recommendations or any queries!")
        st.session_state.user_message = ""


st.text_input("Message ChatGPT", key="user_message",
              on_change=handle_message, placeholder="Type your message...")

# Display chat messages in the chatbox
st.markdown('<div class="chatbox">', unsafe_allow_html=True)
st.markdown('<div class="chatbox-header">What can I help you with?</div>',
            unsafe_allow_html=True)
...
if st.sidebar.button("Get Recommendations"):
    if selected_skills:
        ...
        recommended_courses = match_skills_to_courses(
            selected_skills, course_data)

        # Display recommended courses
        st.subheader(f"Courses Recommended based on selected skills: {
...
# Footer
st.markdown("<div class='footer'>© 2024 Northeastern University. All rights reserved.</div>",
            unsafe_allow_html=True)
